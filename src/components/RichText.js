            ...
            >
                ...
                >
                    ...
                    <Typography
                        onMouseDown={(e) => {
                            e.preventDefault();
                            setEditorState(RichUtils.toggleBlockType(editorState, 'RED'))
                            toggleRichUtil('color')
                        }}
                        variant="p"
                        fontWeight={550}
                        sx={{ cursor: "pointer" }}>
                        <FormatListBulletedIcon color={activeUtils.red ? 'success' : ''} />
                    </Typography>
                </Box>
                <Editor
                    ref={editor}
                    ...
                    plugins={[plugins]}
                    customStyleMap={customStyleMap} // truyền customStyleMap vào đây
                />
            </Box>
